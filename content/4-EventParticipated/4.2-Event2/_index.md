...
### Main content
A monthly community event where speakers from a few companies shared how they build and run AI on AWS. Five talks, most ending with a short demo:

- **Mr. Steve Tran (Cloud Thinker)** started with his own career path, then their product **Cloud Thinker**, an AI agent that helps cloud engineers with things like tracking down incidents and reviewing changes before they go live.
- **Mr. Nghi, Mr. Kiet, Mr. Trung (Renova Cloud / RhoAI)** on **RhoAI**, a Vietnamese voice assistant for call centers. What I remember is why they turn speech into text first instead of voice-to-voice: it works better for Vietnamese and they can control what the bot says.
- **Ms. Bao, Mr. Nguyen (Cloud Kinetic)** on the **AWS DevOps Agent**, which learns your system then investigates an incident on its own and suggests a fix. They demoed it on a site that was suddenly slow and it found the cause.
- **Mr. Truong, Ms. Minh Anh (Noventiq)** on **Amazon Quick** for HR: reading a stack of CVs against a job description and scoring them, so recruiters spend less time screening.
